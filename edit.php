        ...
        <form id="paste-form" method="post">
            <div class="row">
                <div class="col">
                    ...
                    <input id="title" type="text" name="paste-title" class="form-control" placeholder=""><?php echo $title?></div>
            </div>
            <div class="row">
                <div class="col">
                    <label>CONTENIDO DEL PASTE</label>
                    <textarea id="editor" name="paste-content"><?php echo $content?></textarea>
                </div>
            </div>
            <div class="row">
